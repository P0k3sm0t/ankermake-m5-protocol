...
def _check_api_key():
    ...
    # Check ?apikey= URL parameter — validate and strip from URL to keep the
    # key out of browser history and server logs.  No session cookie is set;
    # the redirect forces the client to re-authenticate via session or header.
